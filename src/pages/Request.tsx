          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <label htmlFor="consent" className="text-body cursor-pointer select-none md:whitespace-nowrap">
                ...
                <a href="/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-primary underline decoration-primary underline-offset-4 hover:text-primary/80">персональных данных</a>
